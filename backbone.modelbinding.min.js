(function(a){var b=(function(k,l,h){var e={version:"0.5.1",bind:function(m,n){m.modelBinder=new d(m,n);
m.modelBinder.bind()
...
e._getElementType=function(m){var n=m[0].tagName.toLowerCase();
if(n=="input"){n=m.attr("type");
if(n==undefined||n==""){n="text"
}}return n
};
e.isBindAllowed=function(m,n){var o=e._getElementType(m);
var p=n.bindingAttrConfig[o];
if(typeof(p)!=="undefined"){if(typeof(m.attr(p))==="undefined"){return false
}}return typeof(m.attr("data-skip"))==="undefined"
};
var c=(function(n){var m={};
m.bind=function(o,q,s,r){var p=this;
q.$(o).each(function(z){var w=q.$(this);
if(!e.isBindAllowed(w,r)){return
}var A=e._getElementType(w);
var y=r.getBindingValue(w,A);
var B=function(C,D){w.val(D)
};
var u=function(E,D){var C={};
C[E]=D;
s.set(C)
};
var x=function(C){u(y,q.$(C.target).val())
};
p.registerModelBinding(s,y,B);
p.registerElementBinding(w,x);
var t=s.get(y);
if(typeof t!=="undefined"&&t!==null){w.val(t)
}else{var v=w.val();
if(v){u(y,v)
}}})
};
...
break;
case"disabled":v.attr("disabled",!!w);
break;
